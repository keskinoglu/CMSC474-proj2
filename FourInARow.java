...
public class Location {
	 ...
	 */
	public int convert_location_to_board_position(){
		return x*10 + y;
	}
...
public class Node {
	...
	public static int our_player;
	public static int other_player;
	double value;
	 ...
	 */
	public Node(int player_turn, Location[] player0_pieces, Location[] player1_pieces) {
	 ...
	 */
	public Node(int player_turn, int[] player0_pieces, int[] player1_pieces) {
		this.player_turn = player_turn;
	 ...
	 */
	Public Node(int player_turn, ArrayList<Location> player0_pieces, ArrayList<Location> player1_pieces) {
		this.player_turn = player_turn;
		this.player0_pieces = new Location[4];
		this.player1_pieces = new Location[4];
		for (int i = 0; i < 4; i++) {
	 ...
	 */
	public static void set_our_player(int who_we_are) {
		if (who_we_are == 0) {
			Node.our_player = 0;
			Node.other_player = 1;
		} else {
	 ...
	 */
	public double alpha_beta(int depth, double alpha, double beta) {
	 ...
	 */
	public Move associate_move(Node child) {
		if (this.player_turn == 0) {
			for (int i = 0; i < 4; i++) {
	 ...
	 */
	public double limited_depth_minimax(int depth) {
		int win = this.winner();
		if (win == 1) {
			if (Node.our_player == 0) {
				return 10000;
	 ...
	 */
	public List<Location> generateMovesHelper(Location curr){
	 ...
	 */
	public double eval(int us, int opponent) {
		// return eval_player(player_0) - eval_player(player_1);
		return eval_player(us);
	}
	 ...
	 */
	public double eval_player(int player) {
		int sum_x = 0;
		int sum_y = 0;
		int sum_xy = 0;
		int sum_xx = 0;
	...
	public boolean blocked(int player) {
	...
	public boolean is_book_move() {
		if (Node.our_player == 0) {//Player0's book moves
			...
			if (flaga && flagb && flagc && flagd) { //all the pieces were in the correct location
